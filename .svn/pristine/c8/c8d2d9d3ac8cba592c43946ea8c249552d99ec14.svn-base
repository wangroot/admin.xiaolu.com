...
EOD;
     ...
     * @return $this
     */
    public function textInput($model, $name, $fieldConfig= ['labelOptions' => ['class' => 'control-label col-md-3']], $options=[]){
     ...
     * @return $this
     */
    public function textarea($model, $name, $fieldConfig= ['labelOptions' => ['class' => 'control-label col-md-3']], $options=[]){
     ...
     * 多个单选按钮
     */
    public function radioList($model, $name, $fieldConfig= [] , $data =[] ,$options=[] , $labelClass = ['class' => 'control-label col-md-3']){
        return $this->model($model, $name, $fieldConfig)->radioList($data, $options)->label(null, $labelClass)->hint($this->getHint($model, $name));
    }
    /**
     *下拉框
     * @param $model
    ...
    public function dropDownList($model, $name, $fieldConfig= [] , $data =[] ,$options=[] , $labelClass = ['class' => 'control-label col-md-3']){
        return $this->model($model, $name, $fieldConfig)->dropDownList($data, $options)->label(null, $labelClass)->hint($this->getHint($model, $name));
    }
    ...
    public function select2($model, $name, $config=[], $labelClass = ['class' => 'control-label col-md-3']){
       return $this->model($model, $name)->widget(Select2::className(), $config)->label(null, $labelClass)->hint($this->getHint($model, $name));
    }
...
JS;
     ...
     */
    protected function model($model, $name, $config=[])
    {
        return $this->field($model, $name, $config);
    }
